...
public class HookSystem : MonoBehaviour
{
    ...
    private LayerMask environmentLayer { get { return LayerManager.Instance.defaultEnvironmentLayer; } }
    private LayerMask destructableEnvironmentLayer { get { return LayerManager.Instance.destructableEnvironmentLayer; } }
    ...
    private CharacterController CharacterController { get { return FirstPersonController.Controller; } }
    ...
    private IEnumerator TryDoHook()
    {
        ...
        {
            isHooking = Physics.Raycast(ray, out hit, hookDistance, environmentLayer | destructableEnvironmentLayer, QueryTriggerInteraction.Ignore);
            if (isHooking)
            {
        ...
        else
        {
            ...
            isHooking = Physics.Raycast(ray, out hit, hookDistance - hitDist, environmentLayer | destructableEnvironmentLayer, QueryTriggerInteraction.Ignore);
            if (isHooking)
            {
                FirstPersonController.UseGravity = false;
                float curSpeed = hookStartSpeed;
